...
/**
 * Utility ASCII, Braille, Unicode BitTree tables class.
 *
...
public class BrailleAsciiTables {
  ...
  /**
   * Converts ASCII character to bits representing braille encoding.
   *
   * @param letter char
   * @return String of braille encoding
...
//    prefixing-zeros
    bits = "0".repeat(BYTE_SIZE - bits.length()) + bits;

    return a2bTree.get(bits);
  } // toBraille(char)

  /**
   * Converts a string braille encoding to its corresponding ASCII character.
   *
   * @param bits String encoding of braille character
   * @return String of ASCII char
   */
  ...
  /**
   * Converts a string braille encoding to its corresponding Unicode braille character.
   *
   * @param bits String encoding of braille character
   * @return String of Unicode braille character
   */
